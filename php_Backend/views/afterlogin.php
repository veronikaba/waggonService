 ...
 <div style="overflow-x:auto;">
     <table class="table table-striped table-hover">
        ...
        <tbody id="myTable">
         ...
         if ($result->num_rows > 0 ) {
             while($row = $result->fetch_assoc()) {
                 echo utf8_encode("<tr class='clickable-row' data-href='views/orderdetail.php'><td>".$row["jobnumber"]."</td>".$row["VEHICLENUMBER"]."</td><td>".$row["DESCRIPTION"]."</td><td>".$row["DISPLAYNAME"]. "</td></tr>");
             }
