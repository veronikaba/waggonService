 ...
 <div style="overflow-x:auto;">
     <table class="table table-striped table-hover">
        ...
        <tbody id="myTable">
         ...
         if ($result->num_rows > 0 ) {
             while($row = $result->fetch_assoc()) {
                 echo utf8_encode("<tr class='clickable-row' data-href='views/orderdetail.php' ><td><a href='views/orderdetail.php'>".$row["jobnumber"]."</a></td></a><td><a href='views/orderdetail.php'>".$row["VEHICLENUMBER"]." </a></td><td><a href='views/orderdetail.php'>".$row["DESCRIPTION"]." </a></td><td><a href='views/orderdetail.php'>".$row["DISPLAYNAME"]. "</a></td></tr>");
             }
